import {
  ...
  RadarController,
  ScatterController
} from "./chunk-NITT4L7W.js";
import "./chunk-KU3R3Q5B.js";
import "./chunk-57ICF5QF.js";
...
function create_fragment(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(canvas, file, 40, 0, 935);
    },
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$inject_state = ($$new_props) => {
    ...
    if ("plugins" in $$props) $$invalidate(6, plugins = $$new_props.plugins);
    if ("updateMode" in $$props) $$invalidate(7, updateMode = $$new_props.updateMode);
    if ("chart" in $$props) $$invalidate(2, chart = $$new_props.chart);
    if ("canvasRef" in $$props) $$invalidate(0, canvasRef = $$new_props.canvasRef);
...
function instance2($$self, $$props, $$invalidate) {
  ...
  $$self.$inject_state = ($$new_props) => {
    ...
    if ("props" in $$props) $$invalidate(1, props = $$new_props.props);
    if ("baseChartRef" in $$props) $$invalidate(2, baseChartRef = $$new_props.baseChartRef);
  };
  if ($$props && "$$inject" in $$props) {
    $$self.$inject_state($$props.$$inject);
  }
